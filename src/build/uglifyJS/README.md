**It is the full copy of the uglifyjs-webpack-plugin.
We use it instead of native package because we need to modify uglify options to have a build with 
working packages (Rickshaw in our case)**
